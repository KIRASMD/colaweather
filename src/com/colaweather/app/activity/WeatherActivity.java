...
public class WeatherActivity extends Activity implements OnClickListener{
	...
	private TextView weatherDespTest;
	...
	public void onClick(View v) {
		...
		case R.id.refresh_weather:
			...
			SharedPreferences spfsPreferences=PreferenceManager.getDefaultSharedPreferences(this);
			String weatherCode=spfsPreferences.getString("weather_code", "");
